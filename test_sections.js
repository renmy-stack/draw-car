...
const SHAPES = { '丸68': circle(68), '丸45': circle(45), '丸30': circle(30), '四角60': poly(60, 4), '三角60': poly(60, 3),
  '星65': star(65, 5, 0.45), '歯車65': star(65, 10, 0.75), '棒60': stick(60), '十字60': cross(60), '丸100': circle(100), '四角120': poly(120, 4) };
const SECTIONS = [
  ...
  ['wall', { h: 72 }], ['tunnel', { len: 360 }], ['gate', { h: 72, c: 120, len: 120 }], ['bridge', { len: 560, d: 80, limit: 240 }],
];
const limit = 40;
